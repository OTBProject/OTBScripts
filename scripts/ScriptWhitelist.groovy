...
public boolean execute(ScriptArgs sArgs) {
    ...
    switch (sArgs.argsList[0].toLowerCase()) {
        case "add":
            ...
            BotConfigHelper.addToWhitelist(APIConfig.getBotConfig(), sArgs.argsList[1].toLowerCase());
        ...
        case "remove":
            ...
            BotConfigHelper.removeFromWhitelist(APIConfig.getBotConfig(), sArgs.argsList[1].toLowerCase());
            APIConfig.writeBotConfig();
            String commandStr = ResponseCmd.REMOVE_SUCCESS + " " + sArgs.argsList[1];
            ScriptHelper.runCommand(commandStr, sArgs.user, sArgs.channel, sArgs.destinationChannel, MessagePriority.HIGH);
            return true;
        case "list":
            ArrayList<String> list = new ArrayList<String>(APIConfig.getBotConfig().whitelist);
